...
IF reviewer suggests "implementing properly":
  Search codebase for actual usage (use grep tool)
...
When replying to inline review comments on a PR, reply in the comment thread — not as a top-level PR comment. Use the appropriate tool for your platform:
- **GitHub:** `gh api repos/{owner}/{repo}/pulls/{pr}/comments/{id}/replies`
- **Azure DevOps:** Use the `ado-repo_reply_to_comment` tool
